...
def create_sample_job_description() -> JobDescription:
    ...
    skills = json.dumps([
        "Python", "Machine Learning", "GenAI", "Vertex AI", 
        "Google Cloud", "RAG", "Vector Databases", "Flask", "Streamlit"
    ])
...
def create_sample_resume() -> Resume:
    ...
    skills = json.dumps([
        "Python", "Vertex AI", "Machine Learning", "Flask", "Streamlit",
        "Google Cloud", "GenAI", "Problem Solving"
    ])
...
def create_production_sample_data():
    ...
    jobs_data = [
        {
            ...
            "skills_required": json.dumps(["Python", "TensorFlow", "PyTorch", "GenAI", "MLOps"]),
        ...
        },
        {
            ...
            "skills_required": json.dumps(["Python", "RAG", "Vector Databases", "LangChain", "ChromaDB"]),
            "experience_level": "Mid-level",
            "location": "Remote",
    ...
    resumes_data = [
        ...
        },
        {
            ...
            "skills": json.dumps(["Python", "RAG", "ChromaDB", "LangChain", "Pinecone"]),
            "experience_years": 3
        }
    ]
...
def main():
    ...
    if test_success:
        ...
        if prod_success:
            ...
            print(f"\n🎉 Setup Complete!")
            print(f"Production database: db/interview_database.db")
