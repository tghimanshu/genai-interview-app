...
class InterviewDatabaseOps:
    ...
    def create_job_description(self, job_desc: JobDescription) -> Optional[int]:
        ...
        try:
            ...
            params = (
                job_desc.title, job_desc.company, job_desc.description_text,
                job_desc.description_pdf_path, job_desc.description_image_path,
                job_desc.requirements, job_desc.skills_required, job_desc.experience_level,
                job_desc.location, job_desc.salary_range, job_desc.is_active
            )
    ...
    def create_resume(self, resume: Resume) -> Optional[int]:
        ...
        try:
            ...
            params = (
                resume.candidate_name, resume.email, resume.phone, resume.resume_text,
                resume.resume_pdf_path, resume.resume_image_path, resume.skills,
                resume.experience_years, resume.education, resume.certifications,
                resume.linkedin_url, resume.portfolio_url, resume.is_active
            )
    ...
    def list_resumes(self, active_only: bool = True) -> List[Dict[str, Any]]:
        ...
        try:
            if active_only:
                query = "SELECT * FROM resumes WHERE is_active = 1 ORDER BY created_at DESC"
            else:
    ...
    def create_interview(self, interview: Interview) -> Optional[int]:
        ...
        try:
            ...
            params = (
                interview.session_id, interview.job_description_id, interview.resume_id,
                interview.interview_link, interview.status, interview.scheduled_at,
                interview.started_at, interview.ended_at, interview.duration_minutes,
                interview.interviewer_notes, interview.candidate_feedback,
                interview.technical_assessment, interview.behavioral_assessment
            )
    ...
    def list_interviews(self, status_filter: Optional[str] = None, 
    ...
    def create_match_rating(self, job_description_id: int, resume_id: int,
                           overall_score: float, reasoning: str,
        ...
        try:
            ...
            if existing:
                ...
                params = (
                    job_description_id, resume_id, overall_score, reasoning,
    ...
    def get_match_rating(self, job_description_id: int, resume_id: int) -> Optional[Dict[str, Any]]:
    ...
    def add_interview_recording(self, interview_id: int, recording_type: str,
        ...
        try:
            ...
            params = (
                interview_id, recording_type, file_path, transcript_text,
    ...
    def create_scoring_analysis(self, interview_id: int, scores: Dict[str, Any],
                               model_version: Optional[str] = None) -> Optional[int]:
    ...
    def create_final_score(self, interview_id: int, final_score: float,
                          decision: str, **kwargs) -> Optional[int]:
    ...
    def get_interview_full_results(self, interview_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            results["job_description"] = self.get_job_description(interview["job_description_id"])
    ...
    def log_system_event(self, event_type: str, entity_type: str = None,
                        entity_id: int = None, event_data: Dict[str, Any] = None,
